export const TitleLang = {
  ...
  addOrRemove: (isPresent: boolean, entity: string) => (isPresent ? `Remove ${entity}` : `Add ${entity}`),
  createFor: (singular1: string, singular2: string) => `Create And Link New ${singular1} For This ${singular2}`,
